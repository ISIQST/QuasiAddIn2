Public Class clstest5
    ...
    Public Overrides Sub SetDBase(ByRef NewDBase As String, Optional ByRef voidParam As Object = Nothing)
        ...
        Try
            ...
            If NewDBase = "" Then
                DBPtr = Nothing
                Stress.SetDBase(NewDBase, Nothing)
            Else
    ...
    Public Overrides Sub RunTest()
        ...
        Try
            ...
            Stress.RunStress(Quasi97.clsStress.StressMode.strStoreParams)

            Stress.RunStress(Quasi97.clsStress.StressMode.strRunStress)
            'measuring
            ...
            Stress.RunStress(Quasi97.clsStress.StressMode.strrestoreparams)
        ...
        Catch ex As Exception
            MsgBox("clsTest5:RunTest " & ex.Message)
        End Try
    End Sub
    ...
    Sub UpdateTableDefs(db As OleDb.OleDbConnection)
        ...
        Try
            Dim SQLCom As New OleDb.OleDbCommand("CREATE TABLE QuasiAddIn2_NETSample5 (Setup Integer, Averages Integer)", db)
    ...
    Public Overrides Sub RemoveRecord()
        ...
        Dim sqlcom As New OleDb.OleDbCommand("DELETE * FROM QuasiAddIn2_NetSample5 WHERE Setup=" & Setup, DBPtr)
        Try
            DBPtr.Open()
    ...
    Public Overrides Sub RestoreParameters()
        ...
        Try
            ...
            DBPtr.Open()
            Dim sqlCOM As New OleDb.OleDbCommand("SELECT * FROM QuasiAddIn2_NetSample5 WHERE Setup=" & Setup) With {.Connection = DBPtr}
    ...
    Public Overrides Sub StoreParameters()
        ...
        Try
            Dim SQLCom As New OleDb.OleDbCommand("DELETE * FROM QuasiAddIn2_NETSample5 WHERE Setup=" & Setup.ToString, DBPtr)
            DBPtr.Open()
            Call SQLCom.ExecuteNonQuery()
            SQLCom.CommandText = "INSERT INTO QuasiAddIn2_NETSample5 (Setup, Averages) VALUES (" & _
                Setup.ToString & "," & _
